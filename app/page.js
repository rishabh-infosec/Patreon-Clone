    ...
    <div className="item space-y-3 flex flex-col items-center justify-center">
      ...
      <div className="text-white container mx-auto pb-32 pt-14 flex flex-col items-center justify-center">
       ...
       <div className="flex gap-4 justify-center mt-4">
         <Link href="https://x.com/RishabhP1902" target="_blank">
           <img src="/twitter.svg" alt="Twitter" className="w-8 h-8" />
         </Link>
         <Link href="https://www.linkedin.com/in/er-rishabh/" target="_blank">
           <img src="/linkedin.svg" alt="LinkedIn" className="w-8 h-8" />
         </Link>
         <Link href="https://www.instagram.com/rishabh_pandey2038?igsh=MTE0a2g4dzI5bWt4cA==" target="_blank">
